...
This is the system prompt loaded into the Airia AI agent. It defines how the agent behaves as a SOC triage analyst.

To use: paste the entire block below into the **System Prompt / Instructions** field of your Airia project.
...
| Scenario | Calculation | Score | Level |
|----------|-------------|-------|-------|
| 20 pings | baseline | 0 | Low |
| 45 pings | >30 (+20) | 20 | Low |
| 85 pings | >50 (+30) + ICMP (+15) | 45 | Medium |
| 85 pings (fast) | >50 (+30) + ICMP (+15) + short window (+20) | 65 | High |
| 200 pings (fast) | >100 (+40) + ICMP (+15) + short window (+20) | 75 | High |
| 500 pings (fast, privileged target) | >100 (+40) + ICMP (+15) + short window (+20) + privileged (+20) | 95 | Critical |
